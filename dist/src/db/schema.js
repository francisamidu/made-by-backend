import { serial, text, varchar, timestamp, integer, boolean, inet, uniqueIndex, index, pgSchema, } from 'drizzle-orm/pg-core';
...
// 2. Categories Table
// ---------------------------
export const categories = baseSchema.table('categories', {
...
// ---------------------------
export const terminologies = baseSchema.table('terminologies', {
...
// ---------------------------
export const educationalInsights = baseSchema.table('educational_insights', {
...
// 7. Search Logs Table
// ---------------------------
export const searchLogs = baseSchema.table('search_logs', {
